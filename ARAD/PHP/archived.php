...
<body>
	<?php
		...
		$selectare = mysqli_query($db, "SELECT category_id, subcategory_id, topic_id, title, content, date_posted,author,cond FROM topics WHERE topics.cond=0"); 
	?>
		<div align="center" class = "text" ><h1 data-heading="<?= _ARC; ?>"><?= _ARC; ?></h1></div><!-- imaginea cu Welcome Stranger(daca esti deconectat) -->
